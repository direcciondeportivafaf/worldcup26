      ...
      <div className="mt-12 pt-8 border-t border-white/10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-gradient-to-br from-green-600/30 to-green-800/20 rounded-xl px-5 py-6 shadow-lg border border-green-400/20">
            <SimpleClock timezone="America/Mexico_City" label="México" flag="🇲🇽" />
          </div>
        </div>
        <div className="mt-6">
          <DualClock matchCityTimezone="America/Mexico_City" matchCityName="Estadio Azteca 🇲🇽" />
        </div>
      </div>
    </div>
  );
